...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/budisugianto/paho.mqtt.golang)](https://pkg.go.dev/github.com/budisugianto/paho.mqtt.golang)
[![Go Report Card](https://goreportcard.com/badge/github.com/budisugianto/paho.mqtt.golang)](https://goreportcard.com/report/github.com/budisugianto/paho.mqtt.golang)
...
If you are using [modules](https://blog.golang.org/using-go-modules) then `import "github.com/budisugianto/paho.mqtt.golang"` 
...
`go get github.com/budisugianto/paho.mqtt.golang@master` to get the latest commit.
...
```
go get github.com/budisugianto/paho.mqtt.golang
```
...
using the [pkg.go.dev](https://pkg.go.dev/github.com/budisugianto/paho.mqtt.golang) service.
...
Please report bugs by raising issues for this project in github https://github.com/budisugianto/paho.mqtt.golang/issues
